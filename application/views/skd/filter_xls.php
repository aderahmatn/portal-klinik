 <form role="form" method="POST" action="<?= base_url('skd/excel') ?>" autocomplete="off">
     ...
     <div class="field">
         ...
         <div class="row">
             ...
             <div class="col-md-3">
                 <div class="form-group required">
                     ...
                     <select class="form-control select-status  <?php echo form_error('fstatus_skd[]') ? 'is-invalid' : '' ?>" id="fstatus_skd[]" name="fstatus_skd[]" multiple="multiple" required>
                         <option value="all" selected>SEMUA STATUS</option>
         ...
         <div class="form-group required">
             <table id="tableModal" class="display nowrap text-sm table-sm mt-4" style="width:100%">
                 <thead>
                     <tr>
