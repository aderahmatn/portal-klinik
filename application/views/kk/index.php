                        ...
                        <tbody class="text-uppercase">
                            ...
                            foreach ($kk as $key) : ?>
                                <tr class="text-uppercase">
                                    ...
                                    <td>
                                        <?= TanggalIndo($key->tgl_kejadian) . ' ' . $key->jam_kejadian ?>
                                    </td>
                                    <td>
                                        <?= $key->nama_lengkap ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="javascript:;" onclick="getDetail('<?= encrypt_url($key->id_kk) ?>')" data-toggle="modal" data-target="#modal_detail" data-toggle="tooltip" title="LIHAT DETAIL">
                                                ...
                                                <a href="<?= base_url('kk/edit/') . encrypt_url($key->id_kk) ?>" data-toggle="tooltip" title="EDIT DATA">
                                                ...
                                                <a href="#" class="dropdown-item" onclick="deleteConfirm('<?= base_url() . 'kk/delete/' . encrypt_url($key->id_kk) ?>')" data-toggle="tooltip" title="HAPUS DATA">
                                                    <div class="row">
