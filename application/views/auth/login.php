...
<head>
    ...
    <title>PORTAL KLINIK | Login</title>
...
<body class="hold-transition login-page bg-dark">
    <div class="login-box ">
        ...
        <!-- /.login-logo -->
        <div class="card ">
            <div class="card-body login-card-body rounded elevation-4">
                <div class="login-logo mb-0">
                    <img src="<?= base_url() . 'assets/images/favicon.png' ?>" class="rounded mx-auto" alt="..." width="30%">
                    <p class="font-weight-light text-info mb-0" style="font-size:1.8rem;">PORTAL KLINIK</p>
                </div>
                <p class="login-box-msg mt-0">Login untuk memulai sesi anda</p>
                ...
                <form action="<?= base_url('auth/process') ?>" method="post" autocomplete="off">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-info btn-block" name="login" id="valid">Log
                                In</button>
                        </div>
                        <!-- /.col -->
                    </div>
